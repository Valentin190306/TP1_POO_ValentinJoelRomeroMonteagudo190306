...
public class TareaMejorada extends Tarea {
    private LocalDate fechaRecordatorio;

    public TareaMejorada (String descripcion, LocalDate fechaVencimiento, String prioridad, LocalDate fechaRecordatorio) {
